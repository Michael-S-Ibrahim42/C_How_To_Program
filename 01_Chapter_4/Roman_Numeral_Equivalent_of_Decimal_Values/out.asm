...
A:/00_SHIELD/02_Codes/03_C/C_How_To_Program/01_Chapter_4/Roman_Numeral_Equivalent_of_Decimal_Values/out.exe:     file format pei-x86-64
...
int main(void)
{
   ...
   140001589:	e8 62 02 00 00       	call   1400017f0 <__main>
  u16 Loc_u16Counter = COUNTER_INIT;
   14000158e:	66 c7 45 fe 01 00    	movw   $0x1,-0x2(%rbp)
  u16 Loc_u16Temp = ZERO_INIT;
   140001594:	66 c7 45 fc 00 00    	movw   $0x0,-0x4(%rbp)
  printf("The table of roman numbers: \n");
   14000159a:	48 8d 05 5f 7a 00 00 	lea    0x7a5f(%rip),%rax        # 140009000 <.rdata>
   1400015a1:	48 89 c1             	mov    %rax,%rcx
   1400015a4:	e8 87 ff ff ff       	call   140001530 <printf>
  for(; Loc_u16Counter <= ROMAN_MAX; Loc_u16Counter++)
   1400015a9:	e9 73 01 00 00       	jmp    140001721 <main+0x1a0>
  {
    Loc_u16Temp = Loc_u16Counter;
   1400015ae:	0f b7 45 fe          	movzwl -0x2(%rbp),%eax
   1400015b2:	66 89 45 fc          	mov    %ax,-0x4(%rbp)
    while(Loc_u16Temp/100 > 0)
   1400015b6:	eb 1a                	jmp    1400015d2 <main+0x51>
    {
      printf("C");
   1400015b8:	48 8d 05 5f 7a 00 00 	lea    0x7a5f(%rip),%rax        # 14000901e <.rdata+0x1e>
   1400015bf:	48 89 c1             	mov    %rax,%rcx
   1400015c2:	e8 69 ff ff ff       	call   140001530 <printf>
      Loc_u16Temp -= 100;
   1400015c7:	0f b7 45 fc          	movzwl -0x4(%rbp),%eax
   1400015cb:	83 e8 64             	sub    $0x64,%eax
   1400015ce:	66 89 45 fc          	mov    %ax,-0x4(%rbp)
    while(Loc_u16Temp/100 > 0)
   1400015d2:	66 83 7d fc 63       	cmpw   $0x63,-0x4(%rbp)
   1400015d7:	7f df                	jg     1400015b8 <main+0x37>
    }/* if */
    if(Loc_u16Temp == 99)
   1400015d9:	66 83 7d fc 63       	cmpw   $0x63,-0x4(%rbp)
   1400015de:	75 1a                	jne    1400015fa <main+0x79>
    {
      printf("IC");
   1400015e0:	48 8d 05 39 7a 00 00 	lea    0x7a39(%rip),%rax        # 140009020 <.rdata+0x20>
   1400015e7:	48 89 c1             	mov    %rax,%rcx
   1400015ea:	e8 41 ff ff ff       	call   140001530 <printf>
      Loc_u16Temp -= 99;
   1400015ef:	0f b7 45 fc          	movzwl -0x4(%rbp),%eax
   1400015f3:	83 e8 63             	sub    $0x63,%eax
   1400015f6:	66 89 45 fc          	mov    %ax,-0x4(%rbp)
    }/* if */
    if(Loc_u16Temp/50 > 0)
   1400015fa:	66 83 7d fc 31       	cmpw   $0x31,-0x4(%rbp)
   1400015ff:	7e 1a                	jle    14000161b <main+0x9a>
    {
      printf("L");
   140001601:	48 8d 05 1b 7a 00 00 	lea    0x7a1b(%rip),%rax        # 140009023 <.rdata+0x23>
   140001608:	48 89 c1             	mov    %rax,%rcx
   14000160b:	e8 20 ff ff ff       	call   140001530 <printf>
      Loc_u16Temp -= 50;
   140001610:	0f b7 45 fc          	movzwl -0x4(%rbp),%eax
   140001614:	83 e8 32             	sub    $0x32,%eax
   140001617:	66 89 45 fc          	mov    %ax,-0x4(%rbp)
    }/* if */
    if(Loc_u16Temp == 49)
   14000161b:	66 83 7d fc 31       	cmpw   $0x31,-0x4(%rbp)
   140001620:	75 36                	jne    140001658 <main+0xd7>
    {
      printf("IL");
   140001622:	48 8d 05 fc 79 00 00 	lea    0x79fc(%rip),%rax        # 140009025 <.rdata+0x25>
   140001629:	48 89 c1             	mov    %rax,%rcx
   14000162c:	e8 ff fe ff ff       	call   140001530 <printf>
      Loc_u16Temp -= 49;
   140001631:	0f b7 45 fc          	movzwl -0x4(%rbp),%eax
   140001635:	83 e8 31             	sub    $0x31,%eax
   140001638:	66 89 45 fc          	mov    %ax,-0x4(%rbp)
    }/* if */
    while(Loc_u16Temp/10 > 0)
   14000163c:	eb 1a                	jmp    140001658 <main+0xd7>
    {
      printf("X");
   14000163e:	48 8d 05 e3 79 00 00 	lea    0x79e3(%rip),%rax        # 140009028 <.rdata+0x28>
   140001645:	48 89 c1             	mov    %rax,%rcx
   140001648:	e8 e3 fe ff ff       	call   140001530 <printf>
      Loc_u16Temp -= 10;
   14000164d:	0f b7 45 fc          	movzwl -0x4(%rbp),%eax
   140001651:	83 e8 0a             	sub    $0xa,%eax
   140001654:	66 89 45 fc          	mov    %ax,-0x4(%rbp)
    while(Loc_u16Temp/10 > 0)
   140001658:	66 83 7d fc 09       	cmpw   $0x9,-0x4(%rbp)
   14000165d:	7f df                	jg     14000163e <main+0xbd>
    }/* if */
    if(Loc_u16Temp == 9)
   14000165f:	66 83 7d fc 09       	cmpw   $0x9,-0x4(%rbp)
   140001664:	75 1a                	jne    140001680 <main+0xff>
    {
      printf("IX");
   140001666:	48 8d 05 bd 79 00 00 	lea    0x79bd(%rip),%rax        # 14000902a <.rdata+0x2a>
   14000166d:	48 89 c1             	mov    %rax,%rcx
   140001670:	e8 bb fe ff ff       	call   140001530 <printf>
      Loc_u16Temp -= 9;
   140001675:	0f b7 45 fc          	movzwl -0x4(%rbp),%eax
   140001679:	83 e8 09             	sub    $0x9,%eax
   14000167c:	66 89 45 fc          	mov    %ax,-0x4(%rbp)
    }/* if */
    if(Loc_u16Temp/5 > 0)
   140001680:	66 83 7d fc 04       	cmpw   $0x4,-0x4(%rbp)
   140001685:	7e 3c                	jle    1400016c3 <main+0x142>
    {
      printf("V");
   140001687:	48 8d 05 9f 79 00 00 	lea    0x799f(%rip),%rax        # 14000902d <.rdata+0x2d>
   14000168e:	48 89 c1             	mov    %rax,%rcx
   140001691:	e8 9a fe ff ff       	call   140001530 <printf>
      Loc_u16Temp = Loc_u16Temp % 5;
   140001696:	0f b7 45 fc          	movzwl -0x4(%rbp),%eax
   14000169a:	0f bf d0             	movswl %ax,%edx
   14000169d:	69 d2 67 66 00 00    	imul   $0x6667,%edx,%edx
   1400016a3:	c1 ea 10             	shr    $0x10,%edx
   1400016a6:	66 d1 fa             	sar    %dx
   1400016a9:	41 89 c0             	mov    %eax,%r8d
   1400016ac:	66 41 c1 f8 0f       	sar    $0xf,%r8w
   1400016b1:	44 29 c2             	sub    %r8d,%edx
   1400016b4:	89 d1                	mov    %edx,%ecx
   1400016b6:	89 ca                	mov    %ecx,%edx
   1400016b8:	c1 e2 02             	shl    $0x2,%edx
   1400016bb:	01 ca                	add    %ecx,%edx
   1400016bd:	29 d0                	sub    %edx,%eax
   1400016bf:	66 89 45 fc          	mov    %ax,-0x4(%rbp)
    }/* if */
    if(Loc_u16Temp == 4)
   1400016c3:	66 83 7d fc 04       	cmpw   $0x4,-0x4(%rbp)
   1400016c8:	75 36                	jne    140001700 <main+0x17f>
    {
      printf("IV");
   1400016ca:	48 8d 05 5e 79 00 00 	lea    0x795e(%rip),%rax        # 14000902f <.rdata+0x2f>
   1400016d1:	48 89 c1             	mov    %rax,%rcx
   1400016d4:	e8 57 fe ff ff       	call   140001530 <printf>
      Loc_u16Temp -= 4;
   1400016d9:	0f b7 45 fc          	movzwl -0x4(%rbp),%eax
   1400016dd:	83 e8 04             	sub    $0x4,%eax
   1400016e0:	66 89 45 fc          	mov    %ax,-0x4(%rbp)
    }/* if */
    while(Loc_u16Temp > 0)
   1400016e4:	eb 1a                	jmp    140001700 <main+0x17f>
    {
      printf("I");
   1400016e6:	48 8d 05 45 79 00 00 	lea    0x7945(%rip),%rax        # 140009032 <.rdata+0x32>
   1400016ed:	48 89 c1             	mov    %rax,%rcx
   1400016f0:	e8 3b fe ff ff       	call   140001530 <printf>
      Loc_u16Temp--;
   1400016f5:	0f b7 45 fc          	movzwl -0x4(%rbp),%eax
   1400016f9:	83 e8 01             	sub    $0x1,%eax
   1400016fc:	66 89 45 fc          	mov    %ax,-0x4(%rbp)
    while(Loc_u16Temp > 0)
   140001700:	66 83 7d fc 00       	cmpw   $0x0,-0x4(%rbp)
   140001705:	7f df                	jg     1400016e6 <main+0x165>
    }/* if */
    printf("\n");
   140001707:	48 8d 05 26 79 00 00 	lea    0x7926(%rip),%rax        # 140009034 <.rdata+0x34>
   14000170e:	48 89 c1             	mov    %rax,%rcx
   140001711:	e8 1a fe ff ff       	call   140001530 <printf>
  for(; Loc_u16Counter <= ROMAN_MAX; Loc_u16Counter++)
   140001716:	0f b7 45 fe          	movzwl -0x2(%rbp),%eax
   14000171a:	83 c0 01             	add    $0x1,%eax
   14000171d:	66 89 45 fe          	mov    %ax,-0x2(%rbp)
   140001721:	66 83 7d fe 64       	cmpw   $0x64,-0x2(%rbp)
   140001726:	0f 8e 82 fe ff ff    	jle    1400015ae <main+0x2d>
  }/* for */

  return(0);
   14000172c:	b8 00 00 00 00       	mov    $0x0,%eax
   140001731:	48 83 c4 30          	add    $0x30,%rsp
...
0000000140001780 <__do_global_ctors>:
   ...
   140001786:	48 8b 15 93 7f 00 00 	mov    0x7f93(%rip),%rdx        # 140009720 <.refptr.__CTOR_LIST__>
...
0000000140001850 <__dyn_tls_init>:
   ...
   140001856:	48 8b 05 a3 7e 00 00 	mov    0x7ea3(%rip),%rax        # 140009700 <.refptr._CRT_MT>
...
00000001400018f0 <_matherr>:
   ...
   140001911:	48 8d 15 ac 78 00 00 	lea    0x78ac(%rip),%rdx        # 1400091c4 <.rdata+0x124>
   ...
   140001928:	48 8d 1d 90 77 00 00 	lea    0x7790(%rip),%rbx        # 1400090bf <.rdata+0x1f>
   ...
   140001957:	48 8d 15 3a 78 00 00 	lea    0x783a(%rip),%rdx        # 140009198 <.rdata+0xf8>
   ...
   14000198e:	c3                   	ret    
   14000198f:	90                   	nop
   140001990:	48 8d 1d 09 77 00 00 	lea    0x7709(%rip),%rbx        # 1400090a0 <.rdata>
   140001997:	eb 96                	jmp    14000192f <_matherr+0x3f>
   140001999:	0f 1f 80 00 00 00 00 	nopl   0x0(%rax)
   1400019a0:	48 8d 1d 59 77 00 00 	lea    0x7759(%rip),%rbx        # 140009100 <.rdata+0x60>
   1400019a7:	eb 86                	jmp    14000192f <_matherr+0x3f>
   1400019a9:	0f 1f 80 00 00 00 00 	nopl   0x0(%rax)
   1400019b0:	48 8d 1d 29 77 00 00 	lea    0x7729(%rip),%rbx        # 1400090e0 <.rdata+0x40>
   1400019b7:	e9 73 ff ff ff       	jmp    14000192f <_matherr+0x3f>
   1400019bc:	0f 1f 40 00          	nopl   0x0(%rax)
   1400019c0:	48 8d 1d 89 77 00 00 	lea    0x7789(%rip),%rbx        # 140009150 <.rdata+0xb0>
   1400019c7:	e9 63 ff ff ff       	jmp    14000192f <_matherr+0x3f>
   1400019cc:	0f 1f 40 00          	nopl   0x0(%rax)
   1400019d0:	48 8d 1d 51 77 00 00 	lea    0x7751(%rip),%rbx        # 140009128 <.rdata+0x88>
   1400019d7:	e9 53 ff ff ff       	jmp    14000192f <_matherr+0x3f>
   1400019dc:	48 8d 1d a3 77 00 00 	lea    0x77a3(%rip),%rbx        # 140009186 <.rdata+0xe6>
...
0000000140001a00 <__report_error>:
   ...
   140001a38:	48 8d 0d a1 77 00 00 	lea    0x77a1(%rip),%rcx        # 1400091e0 <.rdata>
...
0000000140001a70 <mark_section_writable>:
   ...
   140001b1b:	ff 15 13 c7 00 00    	call   *0xc713(%rip)        # 14000e234 <__imp_VirtualQuery>
   ...
   140001b7e:	ff 15 a8 c6 00 00    	call   *0xc6a8(%rip)        # 14000e22c <__imp_VirtualProtect>
   140001b84:	85 c0                	test   %eax,%eax
   140001b86:	75 b6                	jne    140001b3e <mark_section_writable+0xce>
   140001b88:	ff 15 56 c6 00 00    	call   *0xc656(%rip)        # 14000e1e4 <__imp_GetLastError>
   140001b8e:	48 8d 0d c3 76 00 00 	lea    0x76c3(%rip),%rcx        # 140009258 <.rdata+0x78>
   ...
   140001bb1:	48 8d 0d 68 76 00 00 	lea    0x7668(%rip),%rcx        # 140009220 <.rdata+0x40>
   ...
   140001bc5:	48 8d 0d 34 76 00 00 	lea    0x7634(%rip),%rcx        # 140009200 <.rdata+0x20>
...
0000000140001be0 <_pei386_runtime_relocator>:
   ...
   140001c36:	48 8b 3d f3 7a 00 00 	mov    0x7af3(%rip),%rdi        # 140009730 <.refptr.__RUNTIME_PSEUDO_RELOC_LIST_END__>
   140001c3d:	48 8b 1d fc 7a 00 00 	mov    0x7afc(%rip),%rbx        # 140009740 <.refptr.__RUNTIME_PSEUDO_RELOC_LIST__>
   ...
   140001ca3:	4c 8b 3d b6 7a 00 00 	mov    0x7ab6(%rip),%r15        # 140009760 <.refptr.__image_base__>
   ...
   140001dae:	48 8b 3d 77 c4 00 00 	mov    0xc477(%rip),%rdi        # 14000e22c <__imp_VirtualProtect>
   ...
   140001eb1:	4c 8b 35 a8 78 00 00 	mov    0x78a8(%rip),%r14        # 140009760 <.refptr.__image_base__>
   ...
   140001ee8:	48 8d 0d c9 73 00 00 	lea    0x73c9(%rip),%rcx        # 1400092b8 <.rdata+0xd8>
   ...
   140001efc:	48 8d 0d e5 73 00 00 	lea    0x73e5(%rip),%rcx        # 1400092e8 <.rdata+0x108>
   140001f03:	e8 f8 fa ff ff       	call   140001a00 <__report_error>
   140001f08:	48 8d 0d 71 73 00 00 	lea    0x7371(%rip),%rcx        # 140009280 <.rdata+0xa0>
...
0000000140001f80 <_gnu_exception_handler>:
   ...
   140001fbe:	48 8d 15 7b 73 00 00 	lea    0x737b(%rip),%rdx        # 140009340 <.rdata>
...
0000000140002140 <__mingwthr_run_key_dtors.part.0>:
   ...
   140002155:	ff 15 81 c0 00 00    	call   *0xc081(%rip)        # 14000e1dc <__imp_EnterCriticalSection>
   ...
   140002167:	48 8b 3d b6 c0 00 00 	mov    0xc0b6(%rip),%rdi        # 14000e224 <__imp_TlsGetValue>
   14000216e:	48 8b 35 6f c0 00 00 	mov    0xc06f(%rip),%rsi        # 14000e1e4 <__imp_GetLastError>
   ...
   1400021aa:	48 ff 25 53 c0 00 00 	rex.W jmp *0xc053(%rip)        # 14000e204 <__imp_LeaveCriticalSection>
...
00000001400021c0 <___w64_mingwthr_add_key_dtor>:
   ...
   14000220f:	ff 15 c7 bf 00 00    	call   *0xbfc7(%rip)        # 14000e1dc <__imp_EnterCriticalSection>
   ...
   14000222a:	ff 15 d4 bf 00 00    	call   *0xbfd4(%rip)        # 14000e204 <__imp_LeaveCriticalSection>
...
0000000140002250 <___w64_mingwthr_remove_key_dtor>:
   ...
   14000227a:	ff 15 5c bf 00 00    	call   *0xbf5c(%rip)        # 14000e1dc <__imp_EnterCriticalSection>
   ...
   1400022b6:	ff 15 48 bf 00 00    	call   *0xbf48(%rip)        # 14000e204 <__imp_LeaveCriticalSection>
...
00000001400022e0 <__mingw_TLScallback>:
   ...
   140002392:	00 00 00 
   140002395:	ff 15 39 be 00 00    	call   *0xbe39(%rip)        # 14000e1d4 <__IAT_start__>
   ...
   1400023b7:	ff 15 37 be 00 00    	call   *0xbe37(%rip)        # 14000e1f4 <__imp_InitializeCriticalSection>
...
0000000140002450 <_FindPESectionByName>:
   ...
   140002466:	48 8b 15 f3 72 00 00 	mov    0x72f3(%rip),%rdx        # 140009760 <.refptr.__image_base__>
...
00000001400024f0 <__mingw_GetSectionForAddress>:
   1400024f0:	48 8b 15 69 72 00 00 	mov    0x7269(%rip),%rdx        # 140009760 <.refptr.__image_base__>
...
0000000140002570 <__mingw_GetSectionCount>:
   140002570:	48 8b 05 e9 71 00 00 	mov    0x71e9(%rip),%rax        # 140009760 <.refptr.__image_base__>
...
00000001400025b0 <_FindPESectionExec>:
   1400025b0:	4c 8b 05 a9 71 00 00 	mov    0x71a9(%rip),%r8        # 140009760 <.refptr.__image_base__>
...
0000000140002620 <_GetPEImageBase>:
   140002620:	48 8b 05 39 71 00 00 	mov    0x7139(%rip),%rax        # 140009760 <.refptr.__image_base__>
...
0000000140002660 <_IsNonwritableInCurrentImage>:
   140002660:	48 8b 15 f9 70 00 00 	mov    0x70f9(%rip),%rdx        # 140009760 <.refptr.__image_base__>
...
00000001400026f0 <__mingw_enum_import_library_names>:
   1400026f0:	4c 8b 1d 69 70 00 00 	mov    0x7069(%rip),%r11        # 140009760 <.refptr.__image_base__>
...
0000000140002c30 <__pformat_puts>:
   ...
   140002c37:	48 8d 05 32 67 00 00 	lea    0x6732(%rip),%rax        # 140009370 <.rdata>
...
00000001400042e0 <__mingw_pformat>:
   ...
   140004387:	4c 8d 2d 02 50 00 00 	lea    0x5002(%rip),%r13        # 140009390 <.rdata+0x20>
   ...
   140004a62:	48 8d 15 21 49 00 00 	lea    0x4921(%rip),%rdx        # 14000938a <.rdata+0x1a>
   ...
   140004bad:	48 8d 05 c4 47 00 00 	lea    0x47c4(%rip),%rax        # 140009378 <.rdata+0x8>
   ...
   140004c0c:	48 8d 15 73 47 00 00 	lea    0x4773(%rip),%rdx        # 140009386 <.rdata+0x16>
   ...
   140004dfc:	48 8d 15 87 45 00 00 	lea    0x4587(%rip),%rdx        # 14000938a <.rdata+0x1a>
...
0000000140005070 <__gdtoa>:
   ...
   140005137:	48 8d 0d cb 43 00 00 	lea    0x43cb(%rip),%rcx        # 140009509 <.rdata+0x9>
   ...
   14000527b:	f2 0f 59 0d a5 42 00 	mulsd  0x42a5(%rip),%xmm1        # 140009528 <.rdata+0x28>
   140005282:	00 
   ...
   1400052a4:	f2 0f 5c 05 64 42 00 	subsd  0x4264(%rip),%xmm0        # 140009510 <.rdata+0x10>
   1400052ab:	00 
   1400052ac:	f2 0f 59 05 64 42 00 	mulsd  0x4264(%rip),%xmm0        # 140009518 <.rdata+0x18>
   1400052b3:	00 
   1400052b4:	44 0f 48 d2          	cmovs  %edx,%r10d
   1400052b8:	f2 0f 58 05 60 42 00 	addsd  0x4260(%rip),%xmm0        # 140009520 <.rdata+0x20>
   1400052bf:	00 
   ...
   1400052d9:	f2 0f 59 0d 4f 42 00 	mulsd  0x424f(%rip),%xmm1        # 140009530 <.rdata+0x30>
   1400052e0:	00 
   ...
   140005334:	48 8b 0d e5 44 00 00 	mov    0x44e5(%rip),%rcx        # 140009820 <.refptr.__tens_D2A>
   ...
   140005390:	48 8d 0d 76 41 00 00 	lea    0x4176(%rip),%rcx        # 14000950d <.rdata+0xd>
   ...
   1400053c0:	48 8d 0d 39 41 00 00 	lea    0x4139(%rip),%rcx        # 140009500 <.rdata>
   ...
   140005558:	f2 0f 10 25 e0 3f 00 	movsd  0x3fe0(%rip),%xmm4        # 140009540 <.rdata+0x40>
   14000555f:	00 
   ...
   140005572:	f2 0f 58 0d de 3f 00 	addsd  0x3fde(%rip),%xmm1        # 140009558 <.rdata+0x58>
   140005579:	00 
   ...
   1400055aa:	48 8b 0d 6f 42 00 00 	mov    0x426f(%rip),%rcx        # 140009820 <.refptr.__tens_D2A>
   ...
   1400055cd:	f2 0f 10 0d ab 3f 00 	movsd  0x3fab(%rip),%xmm1        # 140009580 <.rdata+0x80>
   1400055d4:	00 
   ...
   140005605:	f2 0f 10 25 33 3f 00 	movsd  0x3f33(%rip),%xmm4        # 140009540 <.rdata+0x40>
   14000560c:	00 
   14000560d:	f2 0f 10 1d 33 3f 00 	movsd  0x3f33(%rip),%xmm3        # 140009548 <.rdata+0x48>
   140005614:	00 
   ...
   14000570e:	f2 0f 59 05 22 3e 00 	mulsd  0x3e22(%rip),%xmm0        # 140009538 <.rdata+0x38>
   140005715:	00 
   ...
   140005a6d:	f2 0f 58 0d e3 3a 00 	addsd  0x3ae3(%rip),%xmm1        # 140009558 <.rdata+0x58>
   140005a74:	00 
   ...
   140005a92:	f2 0f 5c 05 c6 3a 00 	subsd  0x3ac6(%rip),%xmm0        # 140009560 <.rdata+0x60>
   140005a99:	00 
   ...
   140005aa9:	66 0f 57 0d bf 3a 00 	xorpd  0x3abf(%rip),%xmm1        # 140009570 <.rdata+0x70>
   140005ab0:	00 
   ...
   140005ade:	48 8b 15 3b 3d 00 00 	mov    0x3d3b(%rip),%rdx        # 140009820 <.refptr.__tens_D2A>
   ...
   140005b0a:	f2 0f 59 15 4e 3a 00 	mulsd  0x3a4e(%rip),%xmm2        # 140009560 <.rdata+0x60>
   140005b11:	00 
   ...
   140005f8e:	48 8b 15 8b 38 00 00 	mov    0x388b(%rip),%rdx        # 140009820 <.refptr.__tens_D2A>
   ...
   140005ff7:	f2 0f 10 1d 49 35 00 	movsd  0x3549(%rip),%xmm3        # 140009548 <.rdata+0x48>
   140005ffe:	00 
   ...
   1400061a5:	f2 0f 10 15 9b 33 00 	movsd  0x339b(%rip),%xmm2        # 140009548 <.rdata+0x48>
   1400061ac:	00 
   ...
   140006200:	f2 0f 10 05 78 33 00 	movsd  0x3378(%rip),%xmm0        # 140009580 <.rdata+0x80>
   140006207:	00 
   ...
   140006376:	f2 0f 59 05 ca 31 00 	mulsd  0x31ca(%rip),%xmm0        # 140009548 <.rdata+0x48>
   14000637d:	00 
   14000637e:	f2 0f 10 0d ca 31 00 	movsd  0x31ca(%rip),%xmm1        # 140009550 <.rdata+0x50>
   140006385:	00 
   140006386:	bd ff ff ff ff       	mov    $0xffffffff,%ebp
   14000638b:	f2 0f 59 c8          	mulsd  %xmm0,%xmm1
   14000638f:	f2 0f 58 0d c1 31 00 	addsd  0x31c1(%rip),%xmm1        # 140009558 <.rdata+0x58>
   140006396:	00 
...
00000001400068a0 <dtoa_lock>:
   ...
   1400068c1:	48 8b 1d 54 79 00 00 	mov    0x7954(%rip),%rbx        # 14000e21c <__imp_Sleep>
   ...
   14000690e:	48 8b 3d df 78 00 00 	mov    0x78df(%rip),%rdi        # 14000e1f4 <__imp_InitializeCriticalSection>
   ...
   140006948:	48 ff 25 8d 78 00 00 	rex.W jmp *0x788d(%rip)        # 14000e1dc <__imp_EnterCriticalSection>
   14000694f:	90                   	nop
...
0000000140006980 <dtoa_lock_cleanup>:
   ...
   1400069a0:	48 8b 1d 2d 78 00 00 	mov    0x782d(%rip),%rbx        # 14000e1d4 <__IAT_start__>
...
00000001400069d0 <__Balloc_D2A>:
   ...
   140006a5f:	ff 15 9f 77 00 00    	call   *0x779f(%rip)        # 14000e204 <__imp_LeaveCriticalSection>
...
0000000140006ad0 <__Bfree_D2A>:
   ...
   140006b2d:	48 ff 25 d0 76 00 00 	rex.W jmp *0x76d0(%rip)        # 14000e204 <__imp_LeaveCriticalSection>
...
0000000140006bf0 <__i2b_D2A>:
   ...
   140006c8f:	ff 15 6f 75 00 00    	call   *0x756f(%rip)        # 14000e204 <__imp_LeaveCriticalSection>
...
0000000140006e10 <__pow5mult_D2A>:
   ...
   140006ee2:	ff 15 1c 73 00 00    	call   *0x731c(%rip)        # 14000e204 <__imp_LeaveCriticalSection>
   ...
   140006f1d:	ff 15 e1 72 00 00    	call   *0x72e1(%rip)        # 14000e204 <__imp_LeaveCriticalSection>
   ...
   140006f6b:	48 8d 15 2e 26 00 00 	lea    0x262e(%rip),%rdx        # 1400095a0 <p05.0>
   ...
   140006fc8:	ff 15 36 72 00 00    	call   *0x7236(%rip)        # 14000e204 <__imp_LeaveCriticalSection>
...
0000000140007600 <__p__fmode>:
   140007600:	48 8b 05 99 21 00 00 	mov    0x2199(%rip),%rax        # 1400097a0 <.refptr.__imp__fmode>
...
0000000140007610 <__p__commode>:
   140007610:	48 8b 05 79 21 00 00 	mov    0x2179(%rip),%rax        # 140009790 <.refptr.__imp__commode>
...
0000000140007620 <__p__acmdln>:
   140007620:	48 8b 05 59 21 00 00 	mov    0x2159(%rip),%rax        # 140009780 <.refptr.__imp__acmdln>
...
0000000140007630 <_lock_file>:
   ...
   14000765c:	48 ff 25 79 6b 00 00 	rex.W jmp *0x6b79(%rip)        # 14000e1dc <__imp_EnterCriticalSection>
...
00000001400076a0 <_unlock_file>:
   ...
   1400076cc:	48 ff 25 31 6b 00 00 	rex.W jmp *0x6b31(%rip)        # 14000e204 <__imp_LeaveCriticalSection>
...
0000000140007740 <__wcrtomb_cp>:
   ...
   1400077a2:	ff 15 94 6a 00 00    	call   *0x6a94(%rip)        # 14000e23c <__imp_WideCharToMultiByte>
...
0000000140007920 <__mbrtowc_cp>:
   ...
   14000797a:	ff 15 7c 68 00 00    	call   *0x687c(%rip)        # 14000e1fc <__imp_IsDBCSLeadByteEx>
   ...
   1400079ba:	ff 15 4c 68 00 00    	call   *0x684c(%rip)        # 14000e20c <__imp_MultiByteToWideChar>
   ...
   140007a52:	ff 15 b4 67 00 00    	call   *0x67b4(%rip)        # 14000e20c <__imp_MultiByteToWideChar>
...
0000000140007c80 <__C_specific_handler>:
   140007c80:	ff 25 c6 65 00 00    	jmp    *0x65c6(%rip)        # 14000e24c <__imp___C_specific_handler>
   140007c86:	90                   	nop
   140007c87:	90                   	nop

0000000140007c88 <___lc_codepage_func>:
   140007c88:	ff 25 c6 65 00 00    	jmp    *0x65c6(%rip)        # 14000e254 <__imp____lc_codepage_func>
   140007c8e:	90                   	nop
   140007c8f:	90                   	nop

0000000140007c90 <___mb_cur_max_func>:
   140007c90:	ff 25 c6 65 00 00    	jmp    *0x65c6(%rip)        # 14000e25c <__imp____mb_cur_max_func>
   140007c96:	90                   	nop
   140007c97:	90                   	nop

0000000140007c98 <__getmainargs>:
   140007c98:	ff 25 c6 65 00 00    	jmp    *0x65c6(%rip)        # 14000e264 <__imp___getmainargs>
   140007c9e:	90                   	nop
   140007c9f:	90                   	nop

0000000140007ca0 <__iob_func>:
   140007ca0:	ff 25 ce 65 00 00    	jmp    *0x65ce(%rip)        # 14000e274 <__imp___iob_func>
   140007ca6:	90                   	nop
   140007ca7:	90                   	nop

0000000140007ca8 <__set_app_type>:
   140007ca8:	ff 25 ce 65 00 00    	jmp    *0x65ce(%rip)        # 14000e27c <__imp___set_app_type>
   140007cae:	90                   	nop
   140007caf:	90                   	nop

0000000140007cb0 <__setusermatherr>:
   140007cb0:	ff 25 ce 65 00 00    	jmp    *0x65ce(%rip)        # 14000e284 <__imp___setusermatherr>
   140007cb6:	90                   	nop
   140007cb7:	90                   	nop

0000000140007cb8 <_amsg_exit>:
   140007cb8:	ff 25 d6 65 00 00    	jmp    *0x65d6(%rip)        # 14000e294 <__imp__amsg_exit>
   140007cbe:	90                   	nop
   140007cbf:	90                   	nop

0000000140007cc0 <_cexit>:
   140007cc0:	ff 25 d6 65 00 00    	jmp    *0x65d6(%rip)        # 14000e29c <__imp__cexit>
   140007cc6:	90                   	nop
   140007cc7:	90                   	nop

0000000140007cc8 <_errno>:
   140007cc8:	ff 25 de 65 00 00    	jmp    *0x65de(%rip)        # 14000e2ac <__imp__errno>
   140007cce:	90                   	nop
   140007ccf:	90                   	nop

0000000140007cd0 <_initterm>:
   140007cd0:	ff 25 e6 65 00 00    	jmp    *0x65e6(%rip)        # 14000e2bc <__imp__initterm>
   140007cd6:	90                   	nop
   140007cd7:	90                   	nop

0000000140007cd8 <_lock>:
   140007cd8:	ff 25 e6 65 00 00    	jmp    *0x65e6(%rip)        # 14000e2c4 <__imp__lock>
   140007cde:	90                   	nop
   140007cdf:	90                   	nop

0000000140007ce0 <_onexit>:
   140007ce0:	ff 25 e6 65 00 00    	jmp    *0x65e6(%rip)        # 14000e2cc <__imp__onexit>
   140007ce6:	90                   	nop
   140007ce7:	90                   	nop

0000000140007ce8 <_unlock>:
   140007ce8:	ff 25 e6 65 00 00    	jmp    *0x65e6(%rip)        # 14000e2d4 <__imp__unlock>
   140007cee:	90                   	nop
   140007cef:	90                   	nop

0000000140007cf0 <abort>:
   140007cf0:	ff 25 e6 65 00 00    	jmp    *0x65e6(%rip)        # 14000e2dc <__imp_abort>
   140007cf6:	90                   	nop
   140007cf7:	90                   	nop

0000000140007cf8 <calloc>:
   140007cf8:	ff 25 e6 65 00 00    	jmp    *0x65e6(%rip)        # 14000e2e4 <__imp_calloc>
   140007cfe:	90                   	nop
   140007cff:	90                   	nop

0000000140007d00 <exit>:
   140007d00:	ff 25 e6 65 00 00    	jmp    *0x65e6(%rip)        # 14000e2ec <__imp_exit>
   140007d06:	90                   	nop
   140007d07:	90                   	nop

0000000140007d08 <fprintf>:
   140007d08:	ff 25 e6 65 00 00    	jmp    *0x65e6(%rip)        # 14000e2f4 <__imp_fprintf>
   140007d0e:	90                   	nop
   140007d0f:	90                   	nop

0000000140007d10 <fputc>:
   140007d10:	ff 25 e6 65 00 00    	jmp    *0x65e6(%rip)        # 14000e2fc <__imp_fputc>
   140007d16:	90                   	nop
   140007d17:	90                   	nop

0000000140007d18 <free>:
   140007d18:	ff 25 e6 65 00 00    	jmp    *0x65e6(%rip)        # 14000e304 <__imp_free>
   140007d1e:	90                   	nop
   140007d1f:	90                   	nop

0000000140007d20 <fwrite>:
   140007d20:	ff 25 e6 65 00 00    	jmp    *0x65e6(%rip)        # 14000e30c <__imp_fwrite>
   140007d26:	90                   	nop
   140007d27:	90                   	nop

0000000140007d28 <localeconv>:
   140007d28:	ff 25 e6 65 00 00    	jmp    *0x65e6(%rip)        # 14000e314 <__imp_localeconv>
   140007d2e:	90                   	nop
   140007d2f:	90                   	nop

0000000140007d30 <malloc>:
   140007d30:	ff 25 e6 65 00 00    	jmp    *0x65e6(%rip)        # 14000e31c <__imp_malloc>
   140007d36:	90                   	nop
   140007d37:	90                   	nop

0000000140007d38 <memcpy>:
   140007d38:	ff 25 e6 65 00 00    	jmp    *0x65e6(%rip)        # 14000e324 <__imp_memcpy>
   140007d3e:	90                   	nop
   140007d3f:	90                   	nop

0000000140007d40 <memset>:
   140007d40:	ff 25 e6 65 00 00    	jmp    *0x65e6(%rip)        # 14000e32c <__imp_memset>
   140007d46:	90                   	nop
   140007d47:	90                   	nop

0000000140007d48 <signal>:
   140007d48:	ff 25 e6 65 00 00    	jmp    *0x65e6(%rip)        # 14000e334 <__imp_signal>
   140007d4e:	90                   	nop
   140007d4f:	90                   	nop

0000000140007d50 <strerror>:
   140007d50:	ff 25 e6 65 00 00    	jmp    *0x65e6(%rip)        # 14000e33c <__imp_strerror>
   140007d56:	90                   	nop
   140007d57:	90                   	nop

0000000140007d58 <strlen>:
   140007d58:	ff 25 e6 65 00 00    	jmp    *0x65e6(%rip)        # 14000e344 <__imp_strlen>
   140007d5e:	90                   	nop
   140007d5f:	90                   	nop

0000000140007d60 <strncmp>:
   140007d60:	ff 25 e6 65 00 00    	jmp    *0x65e6(%rip)        # 14000e34c <__imp_strncmp>
   140007d66:	90                   	nop
   140007d67:	90                   	nop

0000000140007d68 <vfprintf>:
   140007d68:	ff 25 e6 65 00 00    	jmp    *0x65e6(%rip)        # 14000e354 <__imp_vfprintf>
   140007d6e:	90                   	nop
   140007d6f:	90                   	nop

0000000140007d70 <wcslen>:
   140007d70:	ff 25 e6 65 00 00    	jmp    *0x65e6(%rip)        # 14000e35c <__imp_wcslen>
   140007d76:	90                   	nop
   140007d77:	90                   	nop
...
0000000140007d80 <WideCharToMultiByte>:
   140007d80:	ff 25 b6 64 00 00    	jmp    *0x64b6(%rip)        # 14000e23c <__imp_WideCharToMultiByte>
   140007d86:	90                   	nop
   140007d87:	90                   	nop

0000000140007d88 <VirtualQuery>:
   140007d88:	ff 25 a6 64 00 00    	jmp    *0x64a6(%rip)        # 14000e234 <__imp_VirtualQuery>
   140007d8e:	90                   	nop
   140007d8f:	90                   	nop

0000000140007d90 <VirtualProtect>:
   140007d90:	ff 25 96 64 00 00    	jmp    *0x6496(%rip)        # 14000e22c <__imp_VirtualProtect>
   140007d96:	90                   	nop
   140007d97:	90                   	nop

0000000140007d98 <TlsGetValue>:
   140007d98:	ff 25 86 64 00 00    	jmp    *0x6486(%rip)        # 14000e224 <__imp_TlsGetValue>
   140007d9e:	90                   	nop
   140007d9f:	90                   	nop

0000000140007da0 <Sleep>:
   140007da0:	ff 25 76 64 00 00    	jmp    *0x6476(%rip)        # 14000e21c <__imp_Sleep>
   140007da6:	90                   	nop
   140007da7:	90                   	nop

0000000140007da8 <SetUnhandledExceptionFilter>:
   140007da8:	ff 25 66 64 00 00    	jmp    *0x6466(%rip)        # 14000e214 <__imp_SetUnhandledExceptionFilter>
   140007dae:	90                   	nop
   140007daf:	90                   	nop

0000000140007db0 <MultiByteToWideChar>:
   140007db0:	ff 25 56 64 00 00    	jmp    *0x6456(%rip)        # 14000e20c <__imp_MultiByteToWideChar>
   140007db6:	90                   	nop
   140007db7:	90                   	nop

0000000140007db8 <LeaveCriticalSection>:
   140007db8:	ff 25 46 64 00 00    	jmp    *0x6446(%rip)        # 14000e204 <__imp_LeaveCriticalSection>
   140007dbe:	90                   	nop
   140007dbf:	90                   	nop

0000000140007dc0 <IsDBCSLeadByteEx>:
   140007dc0:	ff 25 36 64 00 00    	jmp    *0x6436(%rip)        # 14000e1fc <__imp_IsDBCSLeadByteEx>
   140007dc6:	90                   	nop
   140007dc7:	90                   	nop

0000000140007dc8 <InitializeCriticalSection>:
   140007dc8:	ff 25 26 64 00 00    	jmp    *0x6426(%rip)        # 14000e1f4 <__imp_InitializeCriticalSection>
   140007dce:	90                   	nop
   140007dcf:	90                   	nop

0000000140007dd0 <GetStartupInfoA>:
   140007dd0:	ff 25 16 64 00 00    	jmp    *0x6416(%rip)        # 14000e1ec <__imp_GetStartupInfoA>
   140007dd6:	90                   	nop
   140007dd7:	90                   	nop

0000000140007dd8 <GetLastError>:
   140007dd8:	ff 25 06 64 00 00    	jmp    *0x6406(%rip)        # 14000e1e4 <__imp_GetLastError>
   140007dde:	90                   	nop
   140007ddf:	90                   	nop

0000000140007de0 <EnterCriticalSection>:
   140007de0:	ff 25 f6 63 00 00    	jmp    *0x63f6(%rip)        # 14000e1dc <__imp_EnterCriticalSection>
   140007de6:	90                   	nop
   140007de7:	90                   	nop

0000000140007de8 <DeleteCriticalSection>:
   140007de8:	ff 25 e6 63 00 00    	jmp    *0x63e6(%rip)        # 14000e1d4 <__IAT_start__>
   140007dee:	90                   	nop
   140007def:	90                   	nop
